				...
				<section>
					...
					<div class="slideshow-container">
						...
						<div class="mySlides fade">
							...
							<img src="images/game1.gif" style="width:100%">
						</div>

						<div class="mySlides fade">
							<div class="numbertext">2 / 3</div>
							<img src="images/game2.gif" style="width:100%">
						</div>

						<div class="mySlides fade">
							<div class="numbertext">3 / 3</div>
							<img src="images/game3.gif" style="width:100%">
						</div>
					...
					<section>
						...
						<div class="posts">
							...
							<article>
								...
								<h3>name${status.index}</h3>
								<p>"writer${status.index}"</p>
								<ul class="actions">
