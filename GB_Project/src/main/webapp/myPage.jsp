		...
		<!-- Wrapper -->
			<div id="wrapper">
				<!-- Menu -->
					...
					<c:choose>
						<c:when test="${!empty MyPageList.MEM_AREA}">
						 <button type="button" onclick="location.href='myPageMemAreainput.jsp';">희망배송지 수정</button>
						</c:when>
						<c:otherwise>			
						 <button type="button" onclick="location.href='myPageMemAreainput.jsp';">희망배송지 설정</button>
